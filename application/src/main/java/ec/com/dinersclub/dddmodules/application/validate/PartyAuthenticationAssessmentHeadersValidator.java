...
public class PartyAuthenticationAssessmentHeadersValidator implements ConstraintValidator<ValidPartyAuthenticationAssessmentHeaders, HttpHeaders> {

    @Override
    public void initialize(ValidPartyAuthenticationAssessmentHeaders constraintAnnotation) {
    }
